...
csv_file_path = 'C:/MaliciousURL-Project/abnormal_dataset/netname/abnormal-netname.csv' 
...
# 파일 경로 및 이름
file_path = "C:/MaliciousURL-Project/abnormal_dataset/netname/abnormal_netname.txt"  # 실제 경로와 원하는 파일 이름으로 변경
